import { getGraphs } from "@assets/refjs/getLayout";
import { getComponents } from "@assets/refjs/getComponents";
import { svgSize, nodeSize, lineAttr } from "@assets/js/config/config";
...
function drawNode(g, specs, nodePos, specsInf) {
  ...
  for (let idx = 0; idx < nodeName.length; idx++) {
	console.log(nodePos[nodeName[idx]][0])
