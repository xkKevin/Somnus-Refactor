...
import { fontSize, svgSize, showRule, tableRender } from "@assets/newrefjs/config";
import { VisData, TransformType, Arrange, Table, TblNum, Rect, SortType } from '@assets/newrefjs/interface'
